-- Migration: Add nutrition calculation function for dishes based on recipe ingredients
-- This calculates nutrition facts from the ingredients table and dish_ingredients quantities

-- Function to calculate nutrition facts for a dish
...
-- Add comment
COMMENT ON FUNCTION public.get_dish_nutrition IS 'Calculates nutrition facts for a dish based on its recipe ingredients. Returns per-serving nutrition information.';
