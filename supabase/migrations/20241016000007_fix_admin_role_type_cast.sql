-- FIX: Cast admin_role to the correct ENUM type
...
BEGIN
    ...
    IF v_admin_role IS NOT NULL THEN
        ...
        -- Insert into admin_users table with proper type casting
        ...
        VALUES (
            ...
            v_admin_role::admin_role,  -- CAST to admin_role ENUM type
            true,
            NOW(),
            NOW()
        );
