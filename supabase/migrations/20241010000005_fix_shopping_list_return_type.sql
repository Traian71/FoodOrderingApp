-- Fix return type for get_shopping_list function (dish_count should be BIGINT not INTEGER)

-- Drop the existing function first
DROP FUNCTION IF EXISTS public.get_shopping_list(DATE, DATE, delivery_group);
