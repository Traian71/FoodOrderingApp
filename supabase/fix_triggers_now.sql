-- Run this script directly in Supabase SQL Editor to fix the triggers
-- This will update the existing trigger functions to only affect confirmed orders

-- Fix the BEFORE trigger function
...
-- Fix the AFTER trigger function
